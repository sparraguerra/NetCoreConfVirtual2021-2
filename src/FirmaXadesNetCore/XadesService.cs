...
namespace FirmaXadesNetCore
{
    ...
    public class XadesService
    {
        ...
        /// <param name="mimeType"></param>
        private void SetContentInternallyDetached(SignatureDocument sigDocument, XmlDocument input)
        {
            ...
            else
            {
                ...
                using (MemoryStream ms = new MemoryStream(Encoding.UTF8.GetBytes(input.InnerXml)))
                {
